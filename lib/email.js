...
email.sendText = (sender, receiver, subject, message)=>{
    const params ={
        Destination: {
...
email.sendHTML = (sender, receiver, subject, message)=>{
    const params ={
        Destination: {
            ToAddresses: [receiver]
        },
...
email.adminDismissalMessage = (username)=>{
    return (`Hello ${username}, this message is to inform you of your dismissal from the admin role on Medpharmconsult.
    Your services during your time as admin were appreciated and we wish you well in your carrer.
    Thank you.`)
